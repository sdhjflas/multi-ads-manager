...
| The brain                       | Sandbox and Amazon Ads connectors, sync with health and watermarks, keyword and product-target search-term ingestion, direct-ASIN harvest/exclusion, bid/budget/pause proposals, operating modes, commitment envelope, outbox execution with read-back and reconciliation, kill switch, business ledger |
